...
local function A333_chrono_year()
    if (not is_timer_scheduled(get_year)) then
        run_at_interval(get_year, 1.0)
    end
end
...
local function A333_set_chrono_all_modes()
...
local function A333_set_chrono_CD()
...
local function A333_set_chrono_ER()
...
local function A333_chrono_monitor_AI()
...
----- FLIGHT START ---------------------------------------------------------------------
local function A333_flight_start_chrono()
...
local function A333_ALL_chronos()
