...
BLUE_MAX_LITERS	= 32.0
GREEN_MAX_LITERS	= 47.0
YELLOW_MAX_LITERS	= 12.0
...
HPRATPBOF			= false			-- HYD RAT P/B OFF          -- A330 Custom
...
JR1CHCTL_1A         = true          -- ENG1 CHANNEL A IN CTL
JR1CHCTL_1B         = true          -- ENG1 CHANNEL B IN CTL
...
JR2AUTOST_2A		= false			-- ENG2 MAN START ACTIVE
JR2AUTOST_2B		= false			-- ENG2 MAN START ACTIVE
JR2CHCTL_2A         = true          -- ENG1 CHANNEL A IN CTL
JR2CHCTL_2B         = true          -- ENG1 CHANNEL B IN CTL
...
JR2MANST_2A			= false			-- ENG1 MAN START ACTIVE
JR2MANST_2B			= false			-- ENG1 MAN START ACTIVE
...
NATCALTROF          = false         -- ATC ALTITUDE REPORTING OFF
NATC1F              = false         -- TRANSPONDER 1 FAIL
NATC2F              = false         -- TRANSPONDER 2 FAIL
NATCSTBY            = false         -- ATC STANDBY MODE
...
NBRQ20_1_NO         = true          -- BARO REF CODING BIT 11 NORMAL OPS
NBRQ20_1_VAL        = true          -- BARO REF CODING BIT 11 DATA VALID
NBRQ20_1_NCD        = false         -- BARO REF CODING BIT 11 DATA OUT-OF-RANGE
NBRQ20_2            = false         -- BARO REF CODING BIT 11
NBRQ20_2_NO         = true          -- BARO REF CODING BIT 11 NORMAL OPS
NBRQ20_2_VAL        = true          -- BARO REF CODING BIT 11 DATA VALID
NBRQ20_2_NCD        = false         -- BARO REF CODING BIT 11 DATA OUT-OF-RANGE
...
NBRQ21_1_NO         = true          -- BARO REF CODING BIT 12 NORMAL OPS
...
NBRQ21_2_NO         = true          -- BARO REF CODING BIT 12 NORMAL OPS
...
NFPBLDG3			= false			-- GPWS FLAPS P/B IN LDG CONFIG 3  -- for A333 see NFFMSLDG3
...
NIRSALG_1           = false         -- IRS USED IN ALIGN SUBMODE
NIRSALG_1_NCD       = false         -- IRS USED IN ALIGN SUBMODE DATA OUT-OF-RANGE
NIRSALG_2           = false         -- IRS USED IN ALIGN SUBMODE
NIRSALG_2_NCD       = false         -- IRS USED IN ALIGN SUBMODE DATA OUT-OF-RANGE
NIRS1AL             = false         -- IRS1 IN ALIGN
NIRS2AL             = false         -- IRS2 IN ALIGN
NIRS3AL             = false         -- IRS3 IN ALIGN
NMINGEN				= false 		-- MINIMUM GENERATED
NOIRSAL             = false         -- ONE IRS IN ALIGN
...
NTCAS               = false         -- TCAS FAULT
NTCASCT_INV         = false         -- TCAS CTL INVALID
NTCASF              = false         -- TCAS FAULT
NTCASINIB			= false			-- TCAS AURAL ADVISORY OUTPUT
NTCASSTBY           = false         -- TCAS STANDBY MODE
NTHDEC				= false			-- THRESHOLD DETECTION
NTOAGD				= false			-- T.O AND GROUND DETECTION
NTUNIRSB26_1        = false         -- TIME UNTIL NAV IRS1 USED COD B26 AT ONE
NTUNIRSB27_1        = false         -- TIME UNTIL NAV IRS1 USED COD B26 AT ONE
NTUNIRSB28_1        = false         -- TIME UNTIL NAV IRS1 USED COD B26 AT ONE
NTUNIRSB26_2        = false         -- TIME UNTIL NAV IRS2 USED COD B26 AT ONE
NTUNIRSB27_2        = false         -- TIME UNTIL NAV IRS2 USED COD B26 AT ONE
NTUNIRSB28_2        = false         -- TIME UNTIL NAV IRS2 USED COD B26 AT ONE
NTUNIRSB26_3        = false         -- TIME UNTIL NAV IRS3 USED COD B26 AT ONE
NTUNIRSB27_3        = false         -- TIME UNTIL NAV IRS3 USED COD B26 AT ONE
NTUNIRSB28_3        = false         -- TIME UNTIL NAV IRS3 USED COD B26 AT ONE
NVFE1				= false 		-- VFE 1
NVFE2				= false 		-- VFE 2
NVFE3				= false 		-- VFE 3
NVFE4				= false 		-- VFE 4
...
WSTS_2				= false			-- STS
WTCASI              = true          -- TCAS INSTALLED
WTCASSTBY           = false         -- TCAS STBY
...
ZISSTSC             = false         -- INOP SYS STATUS COMPUTED
ZISTSC				= false			-- INFO STATUS COMPUTED
...
ZSTSLVL             = false         -- STS LEVEL
ZSTSNMLD            = false         -- STATUS PAGE "NORMAL" MESSAGE IS DISLPAYED
...
Z710NAVL            = false         -- L IRS 7-10 MIN UNTIL NAV
Z6NAVL              = false         -- L IRS 6 MIN UNTIL NAV
Z5NAVL              = false         -- L IRS 5 MIN UNTIL NAV
Z4NAVL              = false         -- L IRS 4 MIN UNTIL NAV
Z3NAVL              = false         -- L IRS 3 MIN UNTIL NAV
Z2NAVL              = false         -- L IRS 2 MIN UNTIL NAV
Z1NAVL              = false         -- L IRS 1 MIN UNTIL NAV
ZNAVL               = false         -- L IRS NAV
Z710NAVR            = false         -- R IRS 7-10 MIN UNTIL NAV
Z6NAVR              = false         -- R IRS 6 MIN UNTIL NAV
Z5NAVR              = false         -- R IRS 5 MIN UNTIL NAV
Z4NAVR              = false         -- R IRS 4 MIN UNTIL NAV
Z3NAVR              = false         -- R IRS 3 MIN UNTIL NAV
Z2NAVR              = false         -- R IRS 2 MIN UNTIL NAV
Z1NAVR              = false         -- R IRS 1 MIN UNTIL NAV
ZNAVR               = false         -- R IRS NAV
Z710NAVC            = false         -- C IRS 7-10 MIN UNTIL NAV
Z6NAVC              = false         -- C IRS 6 MIN UNTIL NAV
Z5NAVC              = false         -- C IRS 5 MIN UNTIL NAV
Z4NAVC              = false         -- C IRS 4 MIN UNTIL NAV
Z3NAVC              = false         -- C IRS 3 MIN UNTIL NAV
Z2NAVC              = false         -- C IRS 2 MIN UNTIL NAV
Z1NAVC              = false         -- C IRS 1 MIN UNTIL NAV
Z7                  = false         -- 7-10 MIN UNTIL NAV
Z6                  = false         -- 6 MIN UNTIL NAV
Z5                  = false         -- 5 MIN UNTIL NAV
Z4                  = false         -- 4 MIN UNTIL NAV
Z3                  = false         -- 3 MIN UNTIL NAV
Z2                  = false         -- 2 MIN UNTIL NAV
Z1                  = false         -- 1 MIN UNTIL NAV
