...
dofile("A333.ecam_fws271.lua")	-- ECP STS PROCESSING
...
dofile("A333.ecam_fws800.lua")	-- ENGINE/WARNING DISPLAY GENERIC INSTRUMENTS
dofile("A333.ecam_fws810.lua")	-- STATUS DISPLAY GENERIC INSTRUMENTS
