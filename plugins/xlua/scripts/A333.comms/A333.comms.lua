...
--*************************************************************************************--
A333DR_audio_panel_capt_call_reset = find_dataref("laminar/A333/audio/capt_call_reset_pos")
A333DR_audio_panel_fo_call_reset = find_dataref("laminar/A333/audio/fo_call_reset_pos")
A333DR_audio_panel_obs_call_reset = find_dataref("laminar/A333/audio/obs_call_reset_pos")

A333_call_emergency_status = find_dataref("laminar/A333/status/call/emergency", "number")
...
A333DR_capt_com1_activated          = create_dataref("laminar/A333/selcal/capt_com1_activated", "number")
A333DR_capt_com2_activated          = create_dataref("laminar/A333/selcal/capt_com2_activated", "number")
A333DR_capt_att_activated          = create_dataref("laminar/A333/selcal/capt_att_activated", "number")
A333DR_capt_gen_activated          = create_dataref("laminar/A333/selcal/capt_gen_activated", "number")
A333DR_fo_com1_activated            = create_dataref("laminar/A333/selcal/fo_com1_activated", "number")
A333DR_fo_com2_activated            = create_dataref("laminar/A333/selcal/fo_com2_activated", "number")
A333DR_fo_att_activated            = create_dataref("laminar/A333/selcal/fo_att_activated", "number")
A333DR_fo_gen_activated            = create_dataref("laminar/A333/selcal/fo_gen_activated", "number")
A333DR_obs_com1_activated           = create_dataref("laminar/A333/selcal/obs_com1_activated", "number")
A333DR_obs_com2_activated           = create_dataref("laminar/A333/selcal/obs_com2_activated", "number")
A333DR_obs_att_activated           = create_dataref("laminar/A333/selcal/obs_att_activated", "number")
A333DR_obs_gen_activated           = create_dataref("laminar/A333/selcal/obs_gen_activated", "number")
...
--*************************************************************************************--
local function selcal_capt_com1_receive_DLhandler() end
local function selcal_capt_com2_receive_DLhandler() end
local function selcal_capt_com1_acknowledge_DLhandler() end
local function selcal_capt_com2_acknowledge_DLhandler() end

local function selcal_fo_com1_receive_DLhandler() end
local function selcal_fo_com2_receive_DLhandler() end
local function selcal_fo_com1_acknowledge_DLhandler() end
local function selcal_fo_com2_acknowledge_DLhandler() end

local function selcal_obs_com1_receive_DLhandler() end
local function selcal_obs_com2_receive_DLhandler() end
local function selcal_obs_com1_acknowledge_DLhandler() end
local function selcal_obs_com2_acknowledge_DLhandler() end


--*************************************************************************************--
--** 				       CREATE READ-WRITE CUSTOM DATAREFS                         **--
--*************************************************************************************--
A333DR_capt_com1_receive = create_dataref("laminar/A333/selcal/capt_com1_receive", "number", selcal_capt_com1_receive_DLhandler)
A333DR_capt_com2_receive = create_dataref("laminar/A333/selcal/capt_com2_receive", "number", selcal_capt_com2_receive_DLhandler)
A333DR_capt_com1_acknowledge = create_dataref("laminar/A333/selcal/capt_com1_acknowledge", "number", selcal_capt_com1_acknowledge_DLhandler)
A333DR_capt_com2_acknowledge = create_dataref("laminar/A333/selcal/capt_com2_acknowledge", "number", selcal_capt_com2_acknowledge_DLhandler)

A333DR_fo_com1_receive = create_dataref("laminar/A333/selcal/fo_com1_receive", "number", selcal_fo_com1_receive_DLhandler)
A333DR_fo_com2_receive = create_dataref("laminar/A333/selcal/fo_com2_receive", "number", selcal_fo_com2_receive_DLhandler)
A333DR_fo_com1_acknowledge = create_dataref("laminar/A333/selcal/fo_com1_acknowledge", "number", selcal_fo_com1_acknowledge_DLhandler)
A333DR_fo_com2_acknowledge = create_dataref("laminar/A333/selcal/fo_com2_acknowledge", "number", selcal_fo_com2_acknowledge_DLhandler)

A333DR_obs_com1_receive = create_dataref("laminar/A333/selcal/obs_com1_receive", "number", selcal_obs_com1_receive_DLhandler)
A333DR_obs_com2_receive = create_dataref("laminar/A333/selcal/obs_com2_receive", "number", selcal_obs_com2_receive_DLhandler)
A333DR_obs_com1_acknowledge = create_dataref("laminar/A333/selcal/obs_com1_acknowledge", "number", selcal_obs_com1_acknowledge_DLhandler)
A333DR_obs_com2_acknowledge = create_dataref("laminar/A333/selcal/obs_com2_acknowledge", "number", selcal_obs_com2_acknowledge_DLhandler)
...
function A333_lcd_display_status()
    ...
    local rtp_L_lcd_to_display = A333DR_rtp_L_lcd_to_display
    local rtp_R_lcd_to_display = A333DR_rtp_R_lcd_to_display
    local rtp_C_lcd_to_display = A333DR_rtp_C_lcd_to_display

    -- SET WHICH LCD TO DISPLAY (PLANEMAKER HIDE/SHOW)
    if A333DR_rtp_L_off_status == 0 then
        if A333DR_rtp_L_vhf_1_status == 1 then
            rtp_L_lcd_to_display = 0
        elseif A333DR_rtp_L_vhf_2_status == 1 then
            rtp_L_lcd_to_display = 1
        else
            rtp_L_lcd_to_display = 99
        end
    end
    ...
    if A333DR_rtp_R_off_status == 0 then
        if A333DR_rtp_R_vhf_1_status == 1 then
            rtp_R_lcd_to_display = 0
        elseif A333DR_rtp_R_vhf_2_status == 1 then
            rtp_R_lcd_to_display = 1
        else
            rtp_R_lcd_to_display = 99
        end
    end

    if A333DR_rtp_C_off_status == 0 then
        if A333DR_rtp_C_vhf_1_status == 1 then
            rtp_C_lcd_to_display = 0
        elseif A333DR_rtp_C_vhf_2_status == 1 then
            rtp_C_lcd_to_display = 1
        else
            rtp_C_lcd_to_display = 99
        end
    end

    A333DR_rtp_L_lcd_to_display = rtp_L_lcd_to_display
    A333DR_rtp_R_lcd_to_display = rtp_R_lcd_to_display
    A333DR_rtp_C_lcd_to_display = rtp_C_lcd_to_display
...
----- AUDIO PANEL CALL LIGHT LOGIC ------------------------------------------------------
local function A333_annun_capt_com1_call()

    local com1DR_receive = A333DR_capt_com1_receive                 -- Future sim internal feature, writeable by users for now
    local com1DR_acknowledge = A333DR_capt_com1_acknowledge
    local com1_activated = 0
    
    if A333DR_audio_panel_capt_call_reset == 1 then
        com1_activated = 0
        com1DR_receive = 0
    end

    if com1DR_receive == 1 then
        com1_activated = 1
    end

    if com1_activated == 1 then
        if com1DR_acknowledge == 1 then
            com1DR_receive = 0
            com1_activated = 0
        end
    end
    ...
    if com1DR_acknowledge == 1 then
        com1_timer = com1_timer + lcl_SIM_PERIOD
    end

    if com1_timer > 5 then
        com1DR_acknowledge = 0
        com1_timer = 0
    end

    A333DR_capt_com1_receive = com1DR_receive
    A333DR_capt_com1_acknowledge = com1DR_acknowledge
    A333DR_capt_com1_activated = com1_activated

	A333DR_capt_att_activated = A333_call_emergency_status
	A333DR_fo_att_activated = A333_call_emergency_status
	A333DR_obs_att_activated = A333_call_emergency_status
...
local function A333_annun_capt_com2_call()

    local com2DR_receive = A333DR_capt_com2_receive                 -- Future sim internal feature, writeable by users for now
    local com2DR_acknowledge = A333DR_capt_com2_acknowledge
    ...
    if com2DR_receive == 1 then
        com2_activated = 1
    end

    if com2_activated == 1 then
        if com2DR_acknowledge == 1 then
            com2DR_receive = 0
            com2_activated = 0
        end
    end
    ...
    if com2DR_acknowledge == 1 then
        com2_timer = com2_timer + lcl_SIM_PERIOD
    end

    if com2_timer > 5 then
        com2DR_acknowledge = 0
        com2_timer = 0
    end

    A333DR_capt_com2_receive = com2DR_receive
    A333DR_capt_com2_acknowledge = com2DR_acknowledge
    A333DR_capt_com2_activated = com2_activated
...
local function A333_annun_fo_com1_call()

    local com1DR_receive = A333DR_fo_com1_receive                 -- Future sim internal feature, writeable by users for now
    local com1DR_acknowledge = A333DR_fo_com1_acknowledge
    local com1_activated = 0

    if A333DR_audio_panel_fo_call_reset == 1 then
        com1_activated = 0
        com1DR_receive = 0
    end
    ...
    A333DR_fo_com1_receive = com1DR_receive
    A333DR_fo_com1_acknowledge = com1DR_acknowledge
    A333DR_fo_com1_activated = com1_activated
...
local function A333_annun_fo_com2_call()

    local com2DR_receive = A333DR_fo_com2_receive                 -- Future sim internal feature, writeable by users for now
    local com2DR_acknowledge = A333DR_fo_com2_acknowledge
    local com2_activated = 0
    ...
    A333DR_fo_com2_receive = com2DR_receive                 -- Future sim internal feature, writeable by users for now
    A333DR_fo_com2_acknowledge = com2DR_acknowledge
    A333DR_fo_com2_activated = com2_activated
...
local function A333_annun_obs_com1_call()

    local com1DR_receive = A333DR_obs_com1_receive
    local com1DR_acknowledge = A333DR_obs_com1_acknowledge
    local com1_activated = 0

    if A333DR_audio_panel_obs_call_reset == 1 then
        com1_activated = 0
        com1DR_receive = 0
    end
    ...
    A333DR_obs_com1_receive = com1DR_receive
    A333DR_obs_com1_acknowledge = com1DR_acknowledge
    A333DR_obs_com1_activated = com1_activated
...
local function A333_annun_obs_com2_call()

    local com2DR_receive = A333DR_obs_com2_receive
    local com2DR_acknowledge = A333DR_obs_com2_acknowledge
    local com2_activated = 0
    ...
    A333DR_obs_com2_receive = com2DR_receive
    A333DR_obs_com2_acknowledge = com2DR_acknowledge
    A333DR_obs_com2_activated = com2_activated
...
local function A333_set_comms_all_modes()
...
local function A333_set_comms_CD()
...
local function A333_set_comms_ER()
...
local function A333_comms_monitor_AI()
...
----- FLIGHT START ---------------------------------------------------------------------
local function A333_flight_start_comms()
...
function after_physics()
    ...
    A333_annun_capt_com1_call()
    A333_annun_capt_com2_call()
    A333_annun_fo_com1_call()
    A333_annun_fo_com2_call()
    A333_annun_obs_com1_call()
    A333_annun_obs_com2_call()
