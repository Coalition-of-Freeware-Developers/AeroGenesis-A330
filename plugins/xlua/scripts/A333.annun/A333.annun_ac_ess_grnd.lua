...
local annun_ac_ess_grnd_brightness = 0
local annun_ac_ess_grnd2_brightness = 0
...
--** 				                  SYSTEM FUNCTIONS           	    			 **--
--*************************************************************************************--
local function A333_annun_ac_ess_grnd_cache_globals()

    lcl_SIM_PERIOD = SIM_PERIOD

    annun_light_switch_dim_or_brt = A333DR_ann_light_switch_pos <= 1
    annun_ac_ess_grnd_brightness = A333DR_annun_brightness_ac_ess_grnd
    annun_ac_ess_grnd2_brightness = A333DR_annun_brightness_ac_ess_grnd_2
...
local function A333_annun_ac_ess_grnd_processing()
...
--=== AFTER PHYSICS =====================================================================
function A333_annun_ac_ess_grnd_after_physics()

    A333_annun_ac_ess_grnd_cache_globals()
    A333_annun_ac_ess_grnd_processing()
